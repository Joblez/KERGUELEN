...
struct Vec3Util
{
	...
	static vector2 X_(vector3 v) { return (v.x, 0f); }
	static vector2 _X(vector3 v) { return (0f, v.x); }
	static vector2 Y_(vector3 v) { return (v.y, 0f); }
	static vector2 _Y(vector3 v) { return (0f, v.y); }
	static vector2 Z_(vector3 v) { return (v.z, 0f); }
	static vector2 _Z(vector3 v) { return (0f, v.z); }
	...
	static vector3 X__(vector3 v) { return (v.x, 0f, 0f); }
	static vector3 _X_(vector3 v) { return (0f, v.x, 0f); }
	static vector3 __X(vector3 v) { return (0f, 0f, v.x); }
	static vector3 Y__(vector3 v) { return (v.y, 0f, 0f); }
	static vector3 _Y_(vector3 v) { return (0f, v.y, 0f); }
	static vector3 __Y(vector3 v) { return (0f, 0f, v.y); }
	static vector3 Z__(vector3 v) { return (v.z, 0f, 0f); }
	static vector3 _Z_(vector3 v) { return (0f, v.z, 0f); }
	static vector3 __Z(vector3 v) { return (0f, 0f, v.z); }

	static vector3 XX_(vector3 v) { return (v.x, v.x, 0f); }
	static vector3 X_X(vector3 v) { return (v.x, 0f, v.x); }
	static vector3 _XX(vector3 v) { return (0f, v.x, v.x); }
	static vector3 XY_(vector3 v) { return (v.x, v.y, 0f); }
	static vector3 X_Y(vector3 v) { return (v.x, 0f, v.y); }
	static vector3 _XY(vector3 v) { return (0f, v.x, v.y); }
	static vector3 XZ_(vector3 v) { return (v.x, v.z, 0f); }
	static vector3 X_Z(vector3 v) { return (v.x, 0f, v.z); }
	static vector3 _XZ(vector3 v) { return (0f, v.x, v.z); }

	static vector3 YX_(vector3 v) { return (v.y, v.x, 0f); }
	static vector3 Y_X(vector3 v) { return (v.y, 0f, v.x); }
	static vector3 _YX(vector3 v) { return (0f, v.y, v.x); }
	static vector3 YY_(vector3 v) { return (v.y, v.y, 0f); }
	static vector3 Y_Y(vector3 v) { return (v.y, 0f, v.y); }
	static vector3 _YY(vector3 v) { return (0f, v.y, v.y); }
	static vector3 YZ_(vector3 v) { return (v.y, v.z, 0f); }
	static vector3 Y_Z(vector3 v) { return (v.y, 0f, v.z); }
	static vector3 _YZ(vector3 v) { return (0f, v.y, v.z); }

	static vector3 ZX_(vector3 v) { return (v.z, v.x, 0f); }
	static vector3 Z_X(vector3 v) { return (v.z, 0f, v.x); }
	static vector3 _ZX(vector3 v) { return (0f, v.z, v.x); }
	static vector3 ZY_(vector3 v) { return (v.z, v.y, 0f); }
	static vector3 Z_Y(vector3 v) { return (v.z, 0f, v.y); }
	static vector3 _ZY(vector3 v) { return (0f, v.z, v.y); }
	static vector3 ZZ_(vector3 v) { return (v.z, v.z, 0f); }
	static vector3 Z_Z(vector3 v) { return (v.z, 0f, v.z); }
	static vector3 _ZZ(vector3 v) { return (0f, v.z, v.z); }
